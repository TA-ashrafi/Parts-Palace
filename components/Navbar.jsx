            ...
            <div className="mx-6">
                <div className="flex items-center justify-between max-w-7xl mx-auto py-4  transition-all">
                    ...
                    <div className="hidden sm:flex items-center gap-4 lg:gap-8 text-slate-600 dark:text-slate-300">
                        ...
                        <form onSubmit={handleSearch} className="hidden xl:flex items-center w-xs text-sm gap-2 bg-slate-100 dark:bg-gray-700 px-4 py-3 rounded-full">
                            <Search size={18} className="text-slate-600 dark:text-slate-300" />
                            <input className="w-full bg-transparent outline-none placeholder-slate-600 dark:placeholder-slate-400 text-slate-900 dark:text-slate-100" type="text" placeholder="Search products" value={search} onChange={(e) => setSearch(e.target.value)} required />
                        </form>

                        <Link href="/cart" className="relative flex items-center gap-2 text-slate-600 dark:text-slate-300">
                            <ShoppingCart size={18} />
                            Cart
                            <button className="absolute -top-1 left-3 text-[8px] text-white bg-slate-600 dark:bg-slate-500 size-3.5 rounded-full">{cartCount}</button>
                        </Link>
